...
import { Geist, Geist_Mono } from "next/font/google"; // Using the same font as before
import "./globals.css";
...
export const metadata: Metadata = {
  ...
  description: "Personal portfolio showcasing my work in web development and design.",
};
